                                                                            ...
                                                                            <div class="col-sm-8 col-xs-10">
                                                                                <div class="quickad-flexbox">
                                                                                    ...
                                                                                    <div class="quickad-flex-cell quickad-vertical-middle">
                                                                                        <a role="button" class="panel-title quickad-js-service-title collapsed" data-toggle="collapse" data-parent=".panel-group" href="#service_8" aria-expanded="false" aria-controls="service_1">
                                                                                            New order email to restaurant owner </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_new_order" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option("email_sub_new_order") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea name="email_message_editor_new_order" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option("email_message_new_order") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea name="email_message_textarea_new_order" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_new_order"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <table class="quickad-codes">
                                                                                            <tbody>
                                                                                            <tr>
                                                                                                <td><input value="{RESTAURANT_NAME}" readonly="readonly" onclick="this.select()">- Restaurant Name</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><input value="{CUSTOMER_NAME}" readonly="readonly" onclick="this.select()">- Customer Name</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><input value="{TABLE_NUMBER}" readonly="readonly" onclick="this.select()">- Table Number</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><input value="{ORDER}" readonly="readonly" onclick="this.select()">- Order Details</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><input value="{MESSAGE}" readonly="readonly" onclick="this.select()">- Customer Message</td>
                                                                                            </tr>
                                                                                            <tr>
